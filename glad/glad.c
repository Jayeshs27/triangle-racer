/*
    ...
    OpenGL loader generated by glad 0.1.36 on Wed May 29 05:36:50 2024.
    ...
    Commandline:
        --profile="compatibility" --api="gl=4.6" --generator="c" --spec="gl" --local-files --extensions="GL_AMD_blend_minmax_factor"
    Online:
